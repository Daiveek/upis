...
export default function Home() {
  ...
  return <main className="min-h-screen overflow-x-hidden bg-cream">
    ...
    <footer className="mx-auto flex max-w-7xl flex-col gap-4 px-5 py-8 text-xs text-[#6c786f] sm:flex-row sm:items-center sm:justify-between sm:px-8 lg:px-10"><p>UPIS is a competition prototype, not an official government service.</p><div className="flex flex-wrap gap-4"><a href="https://www.linkedin.com/in/daiveekram-j/" target="_blank" rel="noreferrer" className="font-semibold text-moss">Built by Daiveekram J</a><button onClick={() => setJudgeGuideOpen(true)}>Judge guide</button><Link href="/help">Help Center</Link><Link href="/scan">Sign in</Link></div></footer>
